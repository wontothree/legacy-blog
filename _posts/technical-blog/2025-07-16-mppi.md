...
$$
\nabla_{xx} V_{ij} 
= - \lambda \left( \dfrac{\Psi\dfrac{\partial \Psi}{\partial \boldsymbol{x}_i \partial \boldsymbol{x}_j} 
- \dfrac{\partial \Psi}{\partial \boldsymbol{x}_i} \cdot \dfrac{\partial \Psi}{\partial \boldsymbol{x}_j}}{\Psi^2} \right)
$$
