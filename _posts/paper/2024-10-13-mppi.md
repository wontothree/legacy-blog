---
title: "[Control] Model Predictive Path Integral Control"
categories:
  - paper
---
...
$$
\Psi(\boldsymbol{x}_{t_0}, t_0) = \mathbb{E}_{\mathbb{P}} \left[ \exp \left( -\dfrac{1}{\lambda} \int_{t_0}^T q(\boldsymbol{x}, t) \; dt \right) \Psi(\boldsymbol{x}_{T}, T) \right]
$$

$$
\Psi(\boldsymbol{x}_{t_0}, t_0) \approx \mathbb{E}_{\mathbb{P}} \left[ \exp \left( -\dfrac{1}{\lambda} S(\tau) \right) \right]
$$
...
# Path integral form of optimal control
...
&= \boldsymbol{\mathcal{G}}(\boldsymbol{x}_{t_0}, t_0) \dfrac{\mathbb{E}_{p} \left[ \exp \left( -\dfrac{1}{\lambda} S(\tau) \right) \left( \dfrac{d\boldsymbol{x}_{t_0}^{(c)}}{\Delta t} - f_c(\boldsymbol{x}_{t_0}, t_0) \right) \right]}{\mathbb{E}_{p} \left[ \exp \left( -\dfrac{1}{\lambda} S(\tau) \right) \right]}
\\

&= \boldsymbol{\mathcal{G}}(\boldsymbol{x}_{t_0}, t_0) \dfrac{\int \exp \left( -\dfrac{1}{\lambda} S(\tau) \right) \left( \dfrac{d\boldsymbol{x}_{t_0}^{(c)}}{\Delta t} - f_c(\boldsymbol{x}_{t}, t) \right) \mathbf{p}(\tau) d\tau}{\int \exp \left( -\dfrac{1}{\lambda} S(\tau) \right) \mathbf{p}(\tau)d\tau}
\\

&= \boldsymbol{\mathcal{G}}(\boldsymbol{x}_{t_0}, t_0) \dfrac{\int \exp \left( -\dfrac{1}{\lambda} S(\tau) \right) \left( \dfrac{d\boldsymbol{x}_{t_0}^{(c)}}{\Delta t} - f_c(\boldsymbol{x}_{t}, t) \right) \left(\dfrac{\mathbf{q}(\tau)}{\mathbf{q}(\tau)} \right)\mathbf{p}(\tau) d\tau}{\int \exp \left( -\dfrac{1}{\lambda} S(\tau) \right) \left(\dfrac{\mathbf{q}(\tau)}{\mathbf{q}(\tau)} \right) \mathbf{p}(\tau)d\tau}
\\
